...
public class TreciListActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ListAdapter adapter = new ArrayAdapter<>(TreciListActivity.this, R.layout.list_item, list);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(TreciListActivity.this, TreciDetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                startActivity(new Intent(TreciListActivity.this, PrefsActivity.class));
                break;
        }
